...
const graphqlTools = require('@kamilkisiela/graphql-tools');
...
class UrlLoader {
    ...
    async load(pointer, options) {
        ...
        const body = await fetcher({
            query: graphql.parse(graphql.getIntrospectionQuery({ descriptions: true })),
            variables: {},
        ...
        const schema = common.fixSchemaAst(remoteExecutableSchema, options);
        return {
            location: pointer,
            get document() {
